...
let CommunitiesController = class CommunitiesController {
    ...
    async create(body, req) {
        return this.communitiesService.createCommunity(req.user.id, body.name, body.minCoins);
    }
    async join(body, req) {
        return this.communitiesService.joinCommunity(body.communityId, req.user.id);
    }
    async getPosts(id) {
        return this.communitiesService.getPosts(id);
    }
    async createPost(body, req) {
        return this.communitiesService.createPost(body.communityId, req.user.id, req.user.username, body.text, body.voiceUrl);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CommunitiesController.prototype, "getOne", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CommunitiesController.prototype, "getPosts", null);
__decorate([
